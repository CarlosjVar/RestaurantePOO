 ...
 * @author carlo
 */
public class PedidoNormal extends javax.swing.JFrame {

    /**
     * Creates new form PedidoNormal
     */
    public PedidoNormal() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedidoNormal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PedidoNormal().setVisible(true);
            }
        });
    }
